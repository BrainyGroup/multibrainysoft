...
class UserController extends Controller
{
    ...
    public function create()
    {
        ...
        try{  
            ...
            return Inertia::render('Users/Create',compact('roles', 'translations'));
    ...
    public function show(User $user)
    {
        ...
        try{
            ...
            return Inertia::render('Users/Show',compact('user', 'roles', 'userRoles'));
    ...
    public function edit(User $user)
    {
        ...
        try{
            ...
            return Inertia::render('Users/Edit',compact('user', 'roles', 'userRoles','translations'));
