...
class CenterPolicy
{
     ...
     */
    public function view(User $user, Center $center): Response
    {
        $locale = app()->getLocale();

        $translations = json_decode(file_get_contents(base_path("lang/$locale.json")), true);

        return $user->hasPermissionTo('list centers', $center)
    ...
    public function update(User $user, Center $center): Response
    {
        ...
        return $user->hasPermissionTo('edit centers')
        ? Response::allow()
        : Response::deny($translations['you do not have permission']);
    }
     ...
     */
    public function delete(User $user, Center $center): Response
    {
        $locale = app()->getLocale();
