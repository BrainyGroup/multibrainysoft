...
class DashboardPolicy
{
    ...
    public function viewAny(User $user): Response
    {
        ...
        return $user->hasPermissionTo('list dashboards')
        ? Response::allow()
     ...
     */
    public function view(User $user, Dashboard $dashboard): Response
    {
        $locale = app()->getLocale();

        $translations = json_decode(file_get_contents(base_path("lang/$locale.json")), true);

        return $user->hasPermissionTo('list dashboards', $dashboard)
