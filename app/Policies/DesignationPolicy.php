...
class DesignationPolicy
{
    ...
    public function viewAny(User $user): Response
    {
        ...
        return $user->hasPermissionTo('list designations')
        ? Response::allow()
     ...
     */
    public function view(User $user, Designation $designation): Response
    {
        $locale = app()->getLocale();

        $translations = json_decode(file_get_contents(base_path("lang/$locale.json")), true);

        return $user->hasPermissionTo('list designations', $designation)
     ...
     */
    public function update(User $user, Designation $designation): Response
    {
        $locale = app()->getLocale();

        $translations = json_decode(file_get_contents(base_path("lang/$locale.json")), true);

        return $user->hasPermissionTo('edit designations')
        ? Response::allow()
        : Response::deny($translations['you do not have permission']);
    }
     ...
     */
    public function delete(User $user, Designation $designation): Response
    {
        $locale = app()->getLocale();
