...
class CountryPolicy
{
    ...
    public function viewAny(User $user): Response
    {
        ...
        return $user->hasPermissionTo('list countrys')
        ? Response::allow()
    ...
    public function view(User $user, Country $country): Response
    {
        ...
        return $user->hasPermissionTo('list countrys', $country)
    ...
    public function create(User $user): Response
    {
        ...
        return $user->hasPermissionTo('create countrys')
        ? Response::allow()
        : Response::deny($translations['you do not have permission']);
    }
    ...
    public function update(User $user, Country $country): Response
    {
        ...
        return $user->hasPermissionTo('edit countrys')
        ? Response::allow()
        : Response::deny($translations['you do not have permission']);
    }
    ...
    public function delete(User $user, Country $country): Response
    {
        ...
        return $user->hasPermissionTo('delete countrys')
        ? Response::allow()
        : Response::deny($translations['you do not have permission']);
    }
