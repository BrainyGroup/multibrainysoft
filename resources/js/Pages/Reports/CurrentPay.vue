    ...
    <AuthenticatedLayout  :translations="translations">
        ...
        <div class="mx-4">
            <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
                            <Head :title="`${t('current pay summary')}`" />
                            <h3 class="mb-8 text-3xl font-bold">{{ t('payroll summary') }} {{ max_pay }} </h3>
                           <div class="flex items-center justify-between mb-6">

                                <Link class="inline-flex items-center px-4 py-2 bg-gray-800 border border-t  px-6 py-2 transparent rounded-md font-semibold text-xs text-white tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition" href="/pays/create">
                                    <span>{{ t('New') }}</span>
                            ...
                            <table class="w-full whitespace-nowrap">
                                ...
                                <tr class="hover:bg-gray-100 focus-within:bg-gray-100">
                                   ...
                                   <td class="border-t px-6 py-2">
                                    <a href="/reports/pay_details?max_pay=`${$max_pay}`">{{ t('details') }}  </a>                                       
                                ...
                                <tr class="hover:bg-gray-100 focus-within:bg-gray-100">
                                   ...
                                   <td class="border-t px-6 py-2"> 
                                    <a href="/statutory_payments/create?max_pay={{$max_pay}}&statutory_id={{9999}}&statutory_balance={{$month_paye_balance}}">{{ month_paye_balance }}</a>                                      
                                         
                                   </td>
                                   <td class="border-t px-6 py-2">  
                                    <a href="/reports/paye?max_pay={{$max_pay}}">{{ t('details') }}</a>                                
                                ...
                                <tr class="hover:bg-gray-100 focus-within:bg-gray-100">
                                   ...
                                   <td class="border-t px-6 py-2"> 
                                    <a href="/reports/net_by_bank?max_pay={{$max_pay}}">{{ month_net_balance }}</a>                                      
                                         
                                   </td>
                                   <td class="border-t px-6 py-2">  
                                    <a href="/reports/net_by_bank?max_pay={{$max_pay}}">{{ t('net by bank') }} </a>                                
                                ...
                                <tr v-for="statutory in statutories" :key="statutory.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
                                   ...
                                   <td v-if="statutory.balance > 0" class="border-t px-6 py-2"> 
                                    ...
                                    <a href="/statutory_payments/create?max_pay={{$max_pay}}&statutory_id={{$statutory->statutory_id}}&statutory_balance={{$statutory->balance}}">{{ statutory.balance }}</a>
                                   </td>
                                   ...
                                   <td class="border-t px-6 py-2">  
                                    <a href="/reports/statutory_list?max_pay={{$max_pay}}&statutory_id={{$statutory->statutory_id}}">{{ t('details') }}</a>
                                ...
                                <tr v-else class="hover:bg-red-100 focus-within:bg-red-100 bg-red-200">
                                    <td class="border-t px-6 py-2" colspan="5">                                       
                                        ...
                                        <edit-button  @edit="postPay(`${ max_pay }`)">Yes Post Now</edit-button>  
                                    </td>
