...
const form = useForm({
  _method: "PUT",
  name: props.statutory.name,
  description: props.statutory.description, 

  organization_id: props.statutory.organization_id,
  before_paye: props.statutory.before_paye, 

  statutory_type_id: props.statutory.statutory_type_id,
  base_id: props.statutory.base_id, 

  selection: props.statutory.selection,
  mandatory: props.statutory.mandatory, 

  employee: props.statutory.employee,
  employer: props.statutory.employer, 

  date_required: props.statutory.date_required,
  
});

const updateStatutory = () => {
    form.post(route('statutories.update', props.statutory.id), {
        preserveScroll: true,
...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium text-gray-900">{{ t('edit') }} {{ t('statutory') }}</h2>

        </header>

        <form @submit.prevent="updateStatutory" class="mt-6 space-y-6">
