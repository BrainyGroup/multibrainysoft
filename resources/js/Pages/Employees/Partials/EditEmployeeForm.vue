...
const form = useForm({
  _method: "PUT",
    emplyee_id: props.employee.id,
    full_name: props.user.first_name + ' ' +  props.user.last_name,
    start_date: props.employee.start_date,
    salary_amount: props.salary.amount,
    center_id: props.employee.center_id,
...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium text-gray-900">{{ t('edit')}} {{ t('employee')}}</h2>
