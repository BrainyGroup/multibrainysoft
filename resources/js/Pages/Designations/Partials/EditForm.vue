...
const form = useForm({
  ...
  level_id: props.designation.level_id,
  scale_id: props.designation.scale_id,
});

const updateDesignation = () => {
    form.post(route('designations.update', props.designation.id), {
        preserveScroll: true,
...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium text-gray-900">{{ t('edit') }} {{ t('designation') }}</h2>

        </header>

        <form @submit.prevent="updateDesignation" class="mt-6 space-y-6">
            <div>
